...
- **Still open (not in this issue).** At 375px the criteria strip is 105–157px tall in the conversation view once four chips are filled. It is hidden under the sheet but not collapsed in chat. The options are a single scrolling row, or showing only the filled chips with an "Edit search" toggle. I'm raising this for review rather than choosing.
