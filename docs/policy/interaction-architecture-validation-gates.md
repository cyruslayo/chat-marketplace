...
2. **CopilotKit replacement proof** — replay the same streams through CopilotKit and an independent minimal client, producing identical commands and domain results with no framework types in authoritative packages.
