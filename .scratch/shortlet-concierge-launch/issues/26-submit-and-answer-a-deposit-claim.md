...
- trusted claim-window, refund-progression and response-expiry operations are bound to the authoritative Booking tenant
- wrong-tenant staff/admin/system attempts fail before financial or handoff side effects
- refund summary classification derives from the actual refund obligation identity
- exact final LOCAL test total: 488 passed, 0 failed, 0 skipped, 0 todo.
