...
export function bookingContractArtifactToA2UI({ artifact, surfaceId }: { readonly artifact: BookingContractArtifact; readonly surfaceId: string }): readonly A2UIServerMessage[] {
  ...
  const components: A2UIComponent[] = [
    { id: "booking-contract-root", component: "Column", children: ["booking-contract-title", "booking-contract-parties", "booking-contract-stay", "booking-contract-money", "booking-contract-payment", "booking-contract-policies", "booking-contract-arrival", "booking-contract-version"] },
    ...
    { id: "booking-contract-money", component: "Text", text: `All-In Stay Total: ${amount(facts.allInStayTotalKobo, facts.currency)}; Refundable Security Deposit: ${amount(facts.refundableSecurityDepositKobo, facts.currency)}; Paid: ${amount(facts.amountPaidKobo, facts.currency)}` },
    ...
    { id: "booking-contract-version", component: "Text", text: `Contract version: ${facts.contractVersion}` },
  ];
